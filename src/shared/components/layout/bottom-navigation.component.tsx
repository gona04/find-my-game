  ...
  return (
    <>
     <View style={styles.safeArea}>
       <Header title={questActive ? 'Quest' : 'Explore More'} />
            <ScrollView
              contentContainerStyle={styles.scrollContent}
              showsVerticalScrollIndicator={false}
            >
              <View style={styles.screen}>{questActive ? <Quest.QuestLogScreen /> : <Explore.ExploreMoreScreen />}</View>
            </ScrollView>
...
scrollContent: { paddingHorizontal:0, paddingTop: spacingSize.ss_5, paddingBottom: spacingSize.ss_5 },
  ...
  flexDirection: 'row',
  borderTopWidth: 1,
  borderTopColor: colors.shadeOfWhiteTwo,
  backgroundColor: colors.surface,
  paddingTop: spacingSize.ss_24,
  paddingBottom: 32, // increase this
  minHeight: 100,                   // or increase height
},
