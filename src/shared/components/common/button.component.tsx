...
const styles = StyleSheet.create({
  button: { alignItems: 'center', backgroundColor: colors.yellow, borderRadius: spacingSize.ss_10, padding: spacingSize.ss_10 },
  text: { color: colors.surface, fontSize: fontSizes.fs_16, fontWeight: '800' },
  dim: { opacity: 0.72 },
});
