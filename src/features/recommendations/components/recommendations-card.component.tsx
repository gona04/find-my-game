    ...
    <Animated.View style={{ opacity, transform: [{ translateY }] }}>
      <View style={styles.card}>
        <View style={styles.artworkContainer}>
          <Image source={recommendation.imageUrl} style={styles.artwork} resizeMode="cover" />
        </View>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.gemLine}>💎 {recommendation.rewardPotential} gem potential · {recommendation.rewardFrequency} frequency</Text>

          <Text style={styles.statsLine}>📖 Storyline: {recommendation.storyline ? "Yes" : "No"} ⏱ {recommendation.sessionLength} sessions</Text>
